...
def PIL2Tensor(pil_image):
    return torchvision.transforms.functional.to_tensor(pil_image)*255
...
def Tensor2PIL(tensor_image, mode='RGB'):
    ...
    return torchvision.transforms.functional.to_pil_image(tensor_image.detach()/255, mode=mode)
